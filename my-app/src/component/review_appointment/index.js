...
<div className="">{getAge(a.patientDetails.dob)} | {a.patientDetails.dob} |{a.patientDetails.sex}</div>
...
<div className="">{a.patientDetails.insurance}</div>
	...
	<div className="row mb-3">
	<div className="col-md-12">
		<input type="checkbox" checked={checkterm} className="" onClick={()=>{setCheckterm(!checkterm)}} /> I agree to the <span className="text-primary">Terms and Conditions </span>and <span className="text-primary">Privacy policy.</span>
	...
	<div className="row">	
		<div className="col-12">
			...
			<button type="button" disabled={!checkterm} className="btn btn-primary mb-1" onClick={()=>{ShaduleAppointment()}}>Schedule Appointment</button>
		</div>
</div>	
