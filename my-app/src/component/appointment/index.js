...
<select className="form-select" onChange={(event) => { setSpecialty(event.target.value) }}>
	...
	<div className="mb-3">
<label className="form-label text-white">Reason for visit <span className="text-white">*</span></label>
<select className="form-select" onChange={(event) => { setReason(event.target.value) }}>
                                        <option>COVID-19 Testing</option>

                                    </select>
		<label className="form-label text-white mt-2">What reason should I choose?</label>
</div>
...
<div className="col-md-6 col-6">
	...
	<span className="text-medium text-white">Clear Filters</span>
		</div>
	</div>
	<hr className="mt-0 mb-0"/>
	<div className="mb-3">
<label className="form-label text-white">Provider</label>
<select className="form-select" onChange={(event) => { setProvider(event.target.value) }}>
                                        <option>COVID-19 Testing</option>
...
<select className="form-select" onChange={(event) => { setLoction(event.target.value) }}>
...
<div className="mobile-buttons-container text-center">
<a href="" id="mobileMenuButton" className="menu-button text-center">
<span className="text-start font-size-24px d-block pt-2 mb-1 mt-3">Search</span>
</a>
</div>
</div>
                        ...
                        <div className="card-body">
                            <div className="row">
                                <div className="col-md-12">
                                    <h3 className="text-medium mb-0"><strong>{value.toDateString()} </strong></h3>
                                </div>
                        ...
                        <div className="card-body min-vh-100">
                            <div className="row">
                                <div className="col-md-6">
                                    <h3 className="text-medium mb-1 mt-1"><strong>{location}</strong></h3>
                                </div>
                                <div className="col-md-6 text-sm-end">
                                    <h3 className="mb-0 text-medium">5545 abc, new york, usa, 110010</h3>
                                </div>
                            </div>
                            <hr className="mt-2" />
                            <div className="row">
                                <div className="col-md-2">
                                    <div className="card h-100 hover-scale-up bg-light">
                                        <a className="card-body text-center d-flex flex-column align-items-center" href="#">
                                            ...
                                            <p className="heading mt-3 text-body mb-0"><strong>{reason}</strong></p>
